        ...
        <div className="container grid items-center gap-10 lg:grid-cols-2">
          <div>
            ...
            <p className="mt-6 text-lg text-gray-700">
              Discover carefully selected cosmetics and
              organic products that help you glow naturally
              every day.
            </p>
        ...
        <div className="container">
          ...
          <div className="grid gap-8 md:grid-cols-2">
            ...
            >
              ...
              <p className="mt-4">
                Makeup, serums, lotions, skincare and
                beauty essentials.
              </p>
            </Link>
            ...
            >
              ...
              <p className="mt-4">
                Natural soaps, shea butter, oils and
                wellness products.
              </p>
            </Link>
          </div>
      ...
      <section className="section">
        <div className="container">
          <div className="mb-10 flex items-center justify-between">
            ...
            <Link
              href="/shop"
              className="font-semibold text-[#A9822E]"
            >
              View All →
            </Link>
          </div>
        ...
        <div className="container text-center">
          ...
          <div className="mt-12 grid gap-8 md:grid-cols-3">
            <div className="card p-8">
              ...
              <p className="mt-4">
                Carefully sourced organic and skincare
                products.
              </p>
            </div>
      ...
      <footer className="bg-[#16301F] py-12 text-white">
        <div className="container">
          ...
          <p className="mt-8 text-sm text-gray-400">
            © {new Date().getFullYear()} TS Care Palace.
            All rights reserved.
          </p>
        </div>
      </footer>
